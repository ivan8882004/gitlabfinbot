...
def generate_report(stock_symbol, date, house_view, entry_price, target_price, stop_loss):
    ...
    title_completion = client.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "user", 
            "content": f"Generate a title (about 20 words) and Combine the house view {house_view} with entry price: {entry_price} target price: {target_price} stop loss: {stop_loss} for the following summary for the stock {stock_symbol}:\n\n{combined_summaries}"
...
if __name__ == "__main__":
    generate_report('SBUX US','2024-08-13','Buy',110, 150 , 85)